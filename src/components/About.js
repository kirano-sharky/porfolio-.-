  ...
  return <div id='about' className='h-[900px]'>
    <div className='container mx-auto '>
      ...
      <motion.div variants={fadeIn('up', 0.2)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='relative flex justify-center bottom-10 text-[35px] space-x-4'>
        ...
        { /*github icon*/ }
        <a className='cursor-pointer w-[35px] h-[35px] text-gray-300 hover:bg-white hover:text-black rounded-full transition delay-75' href='https://github.com/meA-sonWat'>
