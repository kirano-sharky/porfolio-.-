    ...
    <div className='container mx-auto pb-16'>
      <div className='flex flex-col lg:flex-row lg:justify-between items-center'>
        ...
        <div className='p-[20px] text-center lg:text-left '>
          <motion.span variants={fadeIn('down', 0.2)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='mb-6 text-[65px] font-semibold leading-[3] text-center lg:text-left'>我是kirano</motion.span>
